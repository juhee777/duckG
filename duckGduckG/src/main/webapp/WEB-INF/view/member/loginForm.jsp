			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" id="loginForm">
					...
					<div class="text-center p-t-115">
						...
						<a class="txt2" id="turnRegist">
							회원가입
						</a>
					</div>
				</form>
				
				<form class="login100-form validate-form" id="registForm" style="display: none;">
					<span class="login100-form-title p-b-26">
						회원가입
					</span>
					
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="registName">
						<span class="focus-input100" data-placeholder="이름"></span>
					</div>

					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="registId">
						<span class="focus-input100" data-placeholder="아이디"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<input class="input100" type="password" name="registPass" onkeyup="enterkey()">
						<span class="focus-input100" data-placeholder="비밀번호"></span>
					</div>
